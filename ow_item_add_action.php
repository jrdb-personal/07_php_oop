...
if(isset($_POST['saveitem'])){
	...
	$query = $objQBuilder->buildQueryCreate('tb_items', ['ItemName', 'ItemDescription', 'ItemPrice', 'ItemImage']);


	$result = $objItem->saveItem($pdoConn, $query, [$objItem->getItemName(), $objItem->getItemDesc(), $objItem->getItemPrice(), $objItem->getItemImg()]);
